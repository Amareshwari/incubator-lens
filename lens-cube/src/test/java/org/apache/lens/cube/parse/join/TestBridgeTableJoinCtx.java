...
public class TestBridgeTableJoinCtx {
  ...
  public void testBridgeTableSelectCtx() throws LensException {
    ...
    assertEquals(selectCtx.getSelectedBridgeExprs().size(), 4);
    assertEquals(selectCtx.getSelectedBridgeExprs(), expectedBridgeExprs);

    selectCtx.processWhereAST(where, where, 0);
    ...
    assertEquals(selectCtx.getSelectedBridgeExprs().size(), 6);
    assertEquals(selectCtx.getSelectedBridgeExprs(), expectedBridgeExprs);
    ...
    assertEquals(selectCtx.getSelectedBridgeExprs().size(), 7);
    assertEquals(selectCtx.getSelectedBridgeExprs(), expectedBridgeExprs);
    ...
    assertEquals(selectCtx.getSelectedBridgeExprs().size(), 9);
    assertEquals(selectCtx.getSelectedBridgeExprs(), expectedBridgeExprs);
  }
}
