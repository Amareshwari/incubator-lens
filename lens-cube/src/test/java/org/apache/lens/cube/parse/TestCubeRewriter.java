...
public class TestCubeRewriter extends TestQueryRewrite {
  ...
  public void testMultiFactMultiStorage() throws ParseException, LensException {
    ...
    String possibleStart1 = "SELECT COALESCE(mq1.zipcode, mq2.zipcode) zipcode, mq1.expr2 expr2, mq2.expr3 expr3 FROM ";
    String possibleStart2 = "SELECT COALESCE(mq1.zipcode, mq2.zipcode) zipcode, mq2.expr2 expr2, mq1.expr3 expr3 FROM ";
